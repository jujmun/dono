...
export function RetroBrowserFooter() {
  return (
    <View>
      ...
      <View className="border-t-2 border-dashed border-retro-ink px-4 py-3.5">
        <Text className="text-center font-retro-mono text-[11px] text-[#5c574f]">
          © {new Date().getFullYear()} DONO — MAKING UNIVERSITY GIVING
