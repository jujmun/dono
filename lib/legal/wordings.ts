/**
 * Exact acceptance / disclosure wording from
 * dono-brain/legal/suites/v3.0/publication-package/CHECKOUT_DISCLOSURES_AND_ACCEPTANCE_WORDING.md
 * and society onboarding forms §2.3. Never edit in place — bump version id instead.
 */
...
export type WordingRecord = {
  id: WordingId;
  text: string;
  accepted: boolean;
};

export function wordingRecord(
  id: WordingId,
  accepted: boolean,
): WordingRecord {
  return { id, text: LEGAL_WORDINGS[id], accepted };
}
