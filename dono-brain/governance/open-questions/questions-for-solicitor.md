...
**Suite under review:** `dono-brain/legal/suites/v2.3/`

> **Repository status note, 7 August 2026:** v3.0 is now the latest working legal
> suite. This question pack was prepared against v2.3 and must be reconciled with
> v3.0 before it is sent to counsel.
**Prepared by:** Dono legal workstream

> **Please read `legal/suites/v2.3/00_v2.3_change_log.md` and `TRUTH.md` first.** Together they record the decisions that changed Dono's model and the verified product position.
