...
> **SUPERSEDED — HISTORICAL ONLY. DO NOT BUILD FROM THIS FILE.** The current payment and refund implementation requirements are in [`../../legal-launch/ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`](../../legal-launch/ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md), and settled product decisions are in [`../../../TRUTH.md`](../../../TRUTH.md). This file preserves old reasoning about student recipients, fee allocation and owner-only refunds.
