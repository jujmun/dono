...
> **HISTORICAL v2.1 INPUT — SUPERSEDED. DO NOT BUILD FROM THIS FILE.** The answers and every resulting build requirement are now centralised in [`../../legal-launch/`](../../legal-launch/README.md). Retain this file only as the original fact-finding record.

**For:** the Dono engineering team
**Historical purpose:** the v2.1 Terms contained **[CONFIRM WITH ENGINEERING]** markers, so this questionnaire asked how the stack worked at that time. Do not answer it now; use the current legal-launch evidence requirements instead.

The original checkboxes and blanks are retained as evidence of what was asked.
