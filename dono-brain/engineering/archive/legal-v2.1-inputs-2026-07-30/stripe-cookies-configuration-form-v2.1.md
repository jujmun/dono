...
> **HISTORICAL v2.1 INPUT — SUPERSEDED. DO NOT COMPLETE OR BUILD FROM THIS FORM.** Its questions and assumptions have been absorbed into the current [`../../legal-launch/`](../../legal-launch/README.md) pack and may contradict [`../../../TRUTH.md`](../../../TRUTH.md).

**Historical purpose:** this form was created to unblock the v2.1 Terms by collecting third-party configuration facts. The blank form is retained as evidence of that process; do not complete it now.
