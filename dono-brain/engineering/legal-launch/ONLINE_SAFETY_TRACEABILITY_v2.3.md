...
>
> 1. **All clause references to the Terms of Service, Community Guidelines and Online Safety Procedures must be re-pointed at the v2.3 documents**, whose numbering has changed. In particular: illegal content is now **ToS clause 18.2**; comments are **ToS clause 17** and **Community Guidelines clause 6**; reporting is **Community Guidelines clause 7**; complaints and appeals are **Community Guidelines clause 8**; enforcement is **ToS Part 9**.
> 2. **CSEA traceability moves to `dono-csea-reporting-procedure-v2.3.md`**, which carries the legal obligation, the moderator procedure, preservation, reporting, the authorised reporters, the two retention clocks and the 12-item pre-launch checklist.
> 3. **The notice-and-action traceability for copyright, trade marks, impersonation, defamation and privacy moves to `dono-notice-and-action-procedure-v2.3.md`.**
> 4. **The illegal-content and children's risk assessments are suspended pending re-performance on current controls** — see the amendment blocks on those documents. Traceability rows depending on their ratings are provisional until they are re-performed and approved.
> 5. **The authoritative build list is `ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`**, section F.
> 6. **The release gate is the Release Control Matrix in `TRUTH.md`.**
...
|---|---|---|
| `05_dono_community_guidelines_v2.3.md` | Public prohibited-content, reporting, complaints and appeals rules | Public source of truth for content and moderation |
| `dono-online-safety-procedures-v2.3.md` | Internal accountability, triage, child safety, CSEA, metrics and assurance | Implements the Community Guidelines without changing public rights |
| `dono-illegal-content-risk-assessment-v2.3.md` | Illegal-content risks, controls and effectiveness monitoring | Explains why the operational controls are required |
| `dono-childrens-risk-assessment-v2.3.md` | Children's access, harm controls and monitoring | Defines child-safe-by-default controls and residual risk |
| `dono-complaints-policy-v2.3.md` | General complaints and route coordination | Defers content/moderation challenges to Community Guidelines clause 8 |
| `dono-dp-complaints-workflow-v2.3.md` | Data-protection complaint handling | Separate statutory route sharing unified intake |
| `dono-incident-response-plan-v2.3.md` | Security/personal-data incidents and emergency containment | CSEA matters defer to the specialist Online Safety procedure |
| `01_dono_terms_of_service_v2.3.md` Parts 7 and 9, and clause 33 | Contractual platform, enforcement, evidence and complaint promises | Must match the Community Guidelines and procedures |
| `ENGINEERING_MODERATION_REQUIREMENTS_v2.3.md` | Build, permissions, data, audit, notices, edge cases and acceptance tests | Implementation blueprint for every operational capability |
