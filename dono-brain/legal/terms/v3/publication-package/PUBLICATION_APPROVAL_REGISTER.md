...
**Status:** **NOTHING IS APPROVED FOR PUBLICATION.** Every row below is unsigned.

---

## 1. What this register does

**One row per document. A document is published only when its row is signed.**
...
3. its **hash** is recorded and matches the bytes to be served; and
...
| G5 | The product serves the approved suite, not a draft stub (CH-15) | Engineering | **OPEN** |
...
### 3.1 Terms of Service — `../01_dono_terms_of_service_v3.0.md`
...
### 3.2 Society Campaign Terms — `../03_dono_society_campaign_terms_v3.0.md`
...
### 3.3 Donor Terms — `../04_dono_donor_terms_v3.0.md`
...
### 3.4 Community Guidelines — `../05_dono_community_guidelines_v3.0.md`
...
### 3.5 Refund and Dispute Policy — `../07_dono_refund_and_dispute_policy_v3.0.md`
...
### 3.6 Verification Notice — `../06_dono_verification_notice_v3.0.md`
...
### 3.7 Privacy Notice — `../08_dono_privacy_notice_v3.0.md`
...
### 3.8 Cookie Notice — `../09_dono_cookie_notice_v3.0.md`
...
### 3.9 Complaints Policy — `../dono-complaints-policy-v3.0.md`
...
| Field | Entry |
|---|---|
| Document | `../02_dono_student_campaign_terms_v3.0.md` |
