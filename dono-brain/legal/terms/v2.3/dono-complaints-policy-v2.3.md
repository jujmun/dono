...
>
> **Amendments applying to this document (Complaints Policy):**
>
> 1. **Single support address.** All complaints, of every kind, are received at **joindono.team@gmail.com**. Dono operates **one** public support address. Every reference to multiple inboxes, category-specific addresses, ticketing systems, role-based queues or shared mailboxes is deleted.
> 2. **Subject-matter precedence.** Content and moderation complaints and appeals are governed by **clause 8 of the Community Guidelines**; refund decisions by the **Refund and Dispute Policy**; data-protection complaints by the **Privacy Notice clause 13.4** and the **Data Protection Complaints Workflow**. This Policy governs everything else — fees, delays, technical faults, and how a process was handled.
> 3. **Service targets, not guarantees.** Every stated response time is a target. Replace any wording that says Dono *will* respond within a period with wording that says Dono *aims* to. Urgent safety matters are handled immediately and outside all targets.
> 4. **Clocks start on notification.** Any period for a user to respond or appeal begins when the user is notified of the decision, not when it was made.
> 5. **Independence.** No person may decide an appeal against their own decision. Where only one reviewer is available, the matter is escalated to another authorised founder rather than self-reviewed.
> 6. **Approval block.** The approval block at the foot of this document applies.
