...
|---|---|---|---|---|
| `../../v1.0/` | 1.0 | 27 July 2026 | 9 | First complete public suite. Nine public-facing documents; no governance records |
| `../../v2.0/` | 2.0 | 30 July 2026 | 11 | Adds the first change log and the forms and assessments task list |
...
| `../../legacy-unversioned/` | mixed | 31 July 2026 | 3 | Three loose documents that sat at the repository root outside any version folder. Retained rather than discarded because their provenance is unclear and they may have been served |

**Total archived files: 117.** SHA-256 for each is in `ARCHIVE_HASHES.tsv`.
...
5. **The loose archive stays.** `../../legacy-unversioned/` is retained precisely because its provenance is unclear.
...
| Archived versions | 6 folders, 117 files |
