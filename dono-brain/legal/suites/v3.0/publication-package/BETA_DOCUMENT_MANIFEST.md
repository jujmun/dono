...
**Status:** **Current content-ready source.** Display artifacts and release authorisation pending.
...
These ten documents define the operative suite. Their substantive v3.0 wording is ready, but the Markdown files are source files. Every document remains **currently unpublished** until its accessible HTML and formal PDF artifacts are generated, hashed and connected to a release that satisfies section 5.

### 2.1 Contractual

| # | Document | File | Version | Applies to |
|---|---|---|---|---|
| 1 | **Terms of Service** | `../public/01_dono_terms_of_service_v3.0.md` | 3.0 | Everyone who creates an account, donates, operates a Campaign or acts for a Society |
| 2 | **Society Campaign Terms** | `../public/03_dono_society_campaign_terms_v3.0.md` | 3.0 | A Society and its Responsible Representative |
| 3 | **Donor Terms** | `../public/04_dono_donor_terms_v3.0.md` | 3.0 | Every Donor, account holder or guest |
| 4 | **Community Guidelines** | `../public/05_dono_community_guidelines_v3.0.md` | 3.0 | Every account holder's content and conduct. Clauses 7 and 8 are open to **anyone, including non-users** |
| 5 | **Refund and Dispute Policy** | `../public/07_dono_refund_and_dispute_policy_v3.0.md` | 3.0 | Every Donation, Donor and Campaign Owner |

### 2.2 Notices — information, not contract

| # | Document | File | Version | Served |
|---|---|---|---|---|
| 6 | **Verification Notice** | `../public/06_dono_verification_notice_v3.0.md` | 3.0 | Publicly; before Society onboarding |
| 7 | **Privacy Notice** | `../public/08_dono_privacy_notice_v3.0.md` | 3.0 | Publicly; linked from every collection point |
| 8 | **Cookie Notice** | `../public/09_dono_cookie_notice_v3.0.md` | 3.0 | Publicly; linked from the consent banner |
...
| 10 | **Complaints Policy** | `../public/dono-complaints-policy-v3.0.md` | 3.0 | Publicly; referenced from Terms of Service clause 33.1 |
...
|---|---|---|
| **Student Campaign Terms** | `../future/02_dono_student_campaign_terms_v3.0.md` | **⚠ NOT OPERATIVE — MUST NOT BE SERVED** |
...
| Document | Purpose |
|---|---|
| `../internal/dono-dpia-v3.0.md` | Data Protection Impact Assessment |
| `../internal/dono-ropa-v3.0.md` | Article 30 record |
| `../internal/dono-appropriate-policy-document-v3.0.md` | Article 9 / 10 condition mapping |
| `../internal/dono-article-14-assessment-v3.0.md` | Article 14 assessment |
| `../internal/dono-legitimate-interests-assessments-v3.0.md` | LIAs |
| `../internal/dono-dpa-register-v3.0.md` | Provider and Article 28 register |
| `../internal/dono-international-transfer-assessment-v3.0.md` | Chapter V assessments |
| `../internal/dono-ico-fee-self-assessment-v3.0.md` | ICO fee determination |
| `../internal/dono-ico-childrens-code-assessment-v3.0.md` | Children's Code assessment |
| `../internal/dono-childrens-risk-assessment-v3.0.md` | OSA children's risk assessment |
| `../internal/dono-illegal-content-risk-assessment-v3.0.md` | OSA illegal content risk assessment |
| `../procedures/dono-online-safety-procedures-v3.0.md` | OSA operating procedure |
| `../procedures/dono-csea-reporting-procedure-v3.0.md` | CSEA procedure |
| `../procedures/dono-csea-legal-readiness-checklist-v3.0.md` | CSEA readiness gate |
| `../procedures/dono-notice-and-action-procedure-v3.0.md` | Notice and action procedure |
| `../procedures/dono-dp-complaints-workflow-v3.0.md` | Data-protection complaints workflow |
| `../procedures/dono-society-onboarding-succession-forms-v3.0.md` | Form specifications |
| `../procedures/dono-refund-decision-checklist-v3.0.md` | Reviewer checklist |
| `../procedures/dono-evidence-review-and-closure-procedure-v3.0.md` | Evidence review procedure |
| `../procedures/dono-financial-crime-sanctions-policy-v3.0.md` | Financial crime and sanctions |
| `../procedures/dono-institutional-referral-protocol-v3.0.md` | Referral protocol |
| `../procedures/dono-incident-response-plan-v3.0.md` | Incident response |
| `../internal/dono-geographic-scope-risk-assessment-v3.0.md` | Geographic scope |
| `../internal/dono-fee-and-processing-cost-reference-v3.0.md` | Internal fee reference |
| `../internal/dono-team-and-contributor-agreement-v3.0.md` | Contractor agreement template |
| `../procedures/dono-wind-down-plan-v3.0.md` | Wind-down plan |

> **The forms in `../procedures/dono-society-onboarding-succession-forms-v3.0.md` are a specification, not a served document.** The *wording* they specify is served, at the versions recorded in `CHECKOUT_DISCLOSURES_AND_ACCEPTANCE_WORDING.md`.
...
| 7 | The product serves the release-authorised v3.0 HTML artifact, not a draft stub or raw Markdown (CH-15) | **Outstanding** |
