...
|---|---|---|---|
| Create and manage a user account | Registered users | Name, email, password, account settings | Contract |
| Check age for creating a Campaign or acting for a Society | Campaign Owners, Society Representatives | Declared date of birth | Contract; legitimate interests (restricting Campaign creation and Society representation to adults) |
...
14.2 **Children.** **There is no minimum age to create an account or to post a comment. Anyone may browse the Platform and anyone may make a Donation, at any age.** You must be 18 or over to create a Campaign or act for a Society. This means we knowingly process a limited amount of personal data about people under 18 — an account holder's registration details and any comments they post, and a donor's name, email, donation record and checkout age confirmation. We ask at checkout for a confirmation that the donor is 18 or over, but **this is a declaration and not a verified age check**; there is no parent-or-guardian-permission alternative. We collect no more from a donor or account holder under 18 than from any other user, do not profile users, do not send marketing without an opt-in, and do not target children in our design or marketing. A parent or guardian may contact us at clause 1.1 to ask about, correct or delete a child's data. We have completed a children's access assessment and a children's risk assessment under the Online Safety Act 2023. **[SOLICITOR SIGN-OFF]**
