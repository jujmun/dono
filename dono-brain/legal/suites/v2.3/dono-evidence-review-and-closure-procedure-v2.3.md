...
| Field | Entry |
|---|---|
| Document | Dono Evidence Review and Campaign Closure Procedure |
| Version | 2.3 |
| Version date | 6 August 2026 |
| Accountable owner | Amrit Kaur Rooprai |
| Reviewed by / Approved by | *(to be completed)* |
| Launch gate | **Paid campaigns must not be enabled until the closure workflow, the immutable donation-time snapshot, the reviewer checklist, the cure cycle, the administrative-closure job and donor notifications N11–N13 are built and tested** (`ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`, items EV-01 to EV-12) |
| Next scheduled review | 6 February 2027 |
| Supersedes | `terms_v2.2/dono-refund-decision-checklist.md` in part; new procedure otherwise |
