...
**Supersedes:** `terms_v2.2/dono-incident-response-plan.md`
...
| **7. Notify — others** | As applicable | Stripe; affected processors; NCA; Ofcom; police; insurers *(Dono holds no insurance, so this step is not available)* |
...
| Field | Entry |
|---|---|
| Document | Dono Incident Response Plan |
| Version | 2.3 |
| Version date | 6 August 2026 |
| Accountable owner | Amrit Kaur Rooprai (incident lead) |
| Reviewed by | *(name, role, date — to be completed)* |
| Approved by | *(name, role, date — to be completed)* |
| Outstanding before it is true | Processor contacts verified and dated; domain registrar and Google contacts completed; Signal incident group created and numbers recorded; weekly rota published; tabletop exercises T1 and T2 run and documented; platform kill switches available. See `ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`, items IN-01 to IN-06 |
| Next scheduled review | Quarterly from 6 November 2026; full review 6 August 2027 |
| Supersedes | `terms_v2.2/dono-incident-response-plan.md` |
