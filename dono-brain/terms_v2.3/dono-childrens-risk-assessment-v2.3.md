...
> 12. **The identity check returns a government-document date of birth for creators**, which is stored but unused — an available control that is not being taken (register item U10).
