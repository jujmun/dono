...
**Supersedes:** `terms_v2.2/dono-financial-crime-payments-policy.md`
...
(d) Dono is not authorised or registered by the FCA and does not carry on a regulated payment service (see `QUESTIONS_FOR_LAWYER.md`, item Q1).
...
3.1 **Campaign Owners** must be students of a Recognised Institution physically studying in the UK. There is no other supported location for a Campaign Owner.
...
| Field | Entry |
|---|---|
| Document | Dono Financial Crime and Sanctions Policy |
| Version | 2.3 |
| Version date | 6 August 2026 |
| Accountable owner | Amrit Kaur Rooprai (financial-crime lead) |
| Reviewed by | *(name, role, date — to be completed)* |
| Approved by | *(name, role, date — to be completed)* |
| Operational before | First live payment |
| Outstanding before it is true | Unsupported Countries List created; screening trigger thresholds configured; reviewer training delivered and recorded; campaign and donation suspension tested end to end. See `ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`, items FC-01 to FC-06 |
| Next scheduled review | 6 August 2027, or earlier on any trigger in clause 9 |
| Supersedes | `terms_v2.2/dono-financial-crime-payments-policy.md` |
