...
> 5. **Simplify succession.** Replace the annual succession framework with the requirement in Society Campaign Terms clause 6: a Society must always have a current Responsible Representative; on a change, the replacement completes onboarding; the outgoing representative must cooperate on transferring the account, records and outstanding obligations; and Dono may prevent new Campaigns and suspend a Campaign to new Donations until the transition is complete.
