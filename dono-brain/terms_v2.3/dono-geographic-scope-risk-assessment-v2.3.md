...
**Decision recorded:** International donors remain permitted during beta. Dono does **not** restrict donations to UK-issued cards or UK donors.
...
|---|---|---|
| **Campaign Owner** | Eligible students of a Recognised Institution, physically studying in the UK. At launch, the University of Oxford only, `ox.ac.uk` addresses only | University-email verification; Stripe Connect onboarding (UK entity); campaign review |
...
1.1 **How this must be described publicly.** "Campaign creators are limited to eligible UK students. Donors may be located internationally where Stripe supports the payment and applicable sanctions and legal restrictions permit." **No document may imply that Dono has assessed, supports or targets any particular overseas jurisdiction.**
...
| Campaign Owners restricted to UK students at one institution | In place |
...
| Field | Entry |
|---|---|
| Document | Dono Geographic Scope and International Donations Risk Assessment |
| Version | 2.3 |
| Version date | 6 August 2026 |
| Accountable owner | Amrit Kaur Rooprai |
| Reviewed by | *(name, role, date — to be completed)* |
| Approved by | *(name, role, date — to be completed)* |
| Outstanding before it is true | Unsupported Countries List; automatic decline; declined-attempt logging. See `ENGINEERING_IMPLEMENTATION_CHECKLIST_v2.3.md`, items GS-01 to GS-03 |
| Next scheduled review | 6 February 2027, or on any trigger in clause 5.1 |
