...
| Display-ready legal files | **Rendered — Markdown, accessible HTML and PDF for all nine public documents, hashed in `manifest.json`.** Not release-authorised | [`legal/live-terms/`](legal/live-terms/) |
| Blockers on serving that copy | **Approval register unsigned; six source edits await sign-off; child-friendly privacy layer drafted but unapproved; ~25 claims depend on unbuilt controls** | [`legal/publication-handoff/PUBLICATION_BLOCKERS.md`](legal/publication-handoff/PUBLICATION_BLOCKERS.md) |
